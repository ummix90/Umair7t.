...
\033[1;91m☞ Auther     : UMAIR7T

\033[1;92m☞ WhatsApp   : 03101583317

\033[1;95m☞ GitHub    : NONE

dP     dP 8888ba.88ba   .d888888  dP  888888ba  d88888P d888888P 

88     88 88  `8b  `8b d8'    88  88  88    `8b     d8'    88    

88     88 88   88   88 88aaaaa88a 88 a88aaaa8P'    d8'     88    

88     88 88   88   88 88     88  88  88   `8b.   d8'      88    

Y8.   .8P 88   88   88 88     88  88  88     88  d8'       88    

`Y88888P' dP   dP   dP 88     88  dP  dP     dP d8'        dP    
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update UMAIR7T Tool')

	print (S + '[' + P + '☞3' + S + ']' + S + ' UMAIR7T WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    psb('WellCome To UMAIR7T')

	    psb('Congratulations UMAIR7T Tool Has Been Updated Successfully')

	    psb('🔓User Name☆Xiddiqui✓')

	    psb('🔓Password ☆ Xiddiqui✓')
	    ...
	    os.system('cd $HOME/UMAIR7T && python2 B4.py')
